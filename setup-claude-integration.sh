...
echo "   2. Use Claude Code - you'll see activity logging!"
echo "   3. Try the output styles: /output-style observability-focused"
echo "   4. Check your statusline for live metrics"
echo ""
...
echo "   • Test hooks: claude doctor"
echo "   • Check server: curl http://localhost:3000/mcp"
echo ""
